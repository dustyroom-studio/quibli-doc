...
| Real-time Gradient editor | **Yes**, in the following shaders: [Stylized Lit](../stylized-lit-shader), [Stylized Foliage](../stylized-foliage-shader), [Skybox](../skybox shader), [Cloud2D](cloud2d-shader)| No (‘Steps’ and ‘Curve’ modes require saving color info into offline internal textures) |
