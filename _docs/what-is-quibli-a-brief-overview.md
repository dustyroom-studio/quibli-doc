...
Important! After the initial release (15 Sep 2021) we got reports about the missing materials in [Sample Scene](../demo-scenes/#sample-scene-with-quibli) Demo scene. The issue has been already fixed and sent for the review.
{: .notice--danger}
